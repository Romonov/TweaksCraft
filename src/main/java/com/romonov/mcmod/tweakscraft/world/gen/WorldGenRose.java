...
public class WorldGenRose implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        if ((newPos != null) && (BlockLoader.ROSE.canPlaceBlockAt(world, newPos))) {
            world.setBlockState(newPos, BlockLoader.ROSE.getDefaultState(), 2);
        }
    }
